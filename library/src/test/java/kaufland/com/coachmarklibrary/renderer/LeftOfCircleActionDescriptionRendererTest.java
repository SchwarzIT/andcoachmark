...
public class LeftOfCircleActionDescriptionRendererTest {
    ...
    public void renderTest() {
        ...
        new LeftOfCircleActionDescriptionRenderer().render(screenRectangle, circleRectangle, actionDescription, actionArrow);
    ...
    public void isRenderingPossibleTest() {
        ...
        Assert.assertTrue(new LeftOfCircleActionDescriptionRenderer().isRenderingPossible(screenRectangle, circleRectangle, actionDescriptionRectangle, actionArrowRectangle));
    ...
    public void renderingNotPossibleNotEnoughLeftSpaceTest() {
        ...
        RectF screenRectangle = new RectF(0, 0, 300, 300);
        RectF circleRectangle = new RectF(50, 50, 75, 75);
        Rect actionDescriptionRectangle = new Rect(0, 0, 40, 20);
        Rect actionArrowRectangle = new Rect(0,0, 10, 10);

        Assert.assertFalse(new LeftOfCircleActionDescriptionRenderer().isRenderingPossible(screenRectangle, circleRectangle, actionDescriptionRectangle, actionArrowRectangle));
